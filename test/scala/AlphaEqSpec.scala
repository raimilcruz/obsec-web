...
import ObSec.Ast.Type
import ObSec.Parsing.ObSecParser
import ObSec.Static.{TypeEquivalence, AmadioCardelliSubtyping}
import org.scalatest.FlatSpec

/**
  * Created by rcc on 4/2/2017.
  */
//TODO: Use implicit to convert AlphaEquivalence.alphaEq(t11,t22) to t1 alphaEq t2
...
class AlphaEqSpec extends FlatSpec{
  ...
  "Alpha Eq 0" must "work" in{
    ...
    (t1,t2) match {
      case (Right(t11),Right(t22)) => TypeEquivalence.alphaEq(t11,t22)
